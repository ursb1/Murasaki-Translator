...
export function HardwareMonitorBar({ data, lang }: HardwareMonitorBarProps) {
  ...
  return (
    <div
      className="w-full bg-card border-b border-border px-3 py-2.5 flex items-center justify-between text-xs font-mono select-none transition-colors dark:bg-card/90"
    >
      {/* GPU Name - 允许收缩 */}
